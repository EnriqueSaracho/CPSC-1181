...
/**
 * The purpose of the server is to compute the area when a radius is sent by a
 * client.
 * The Labo9Server should serve many clients.
 * The client communicates to the server that it's done sending radius and the
 * server
